...
import CourseLayout from '../../component/courseuserdata';
...
export async function getServerSideProps({ query }) {
  ...
  try {
  const response = await axios.get('https://nestjsproject-production-364f.up.railway.app/reg/findcourse/'+inputValue);
