import NoteLayout from '../../component/noteuserdata';
...
export async function getServerSideProps({ query }) {
  ...
  try {
  const response = await axios.get('https://nestjsproject-production-364f.up.railway.app/reg/findnote/'+inputValue);
