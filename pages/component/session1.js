...
export default function Session() {
  ...
  useEffect(() => {
    ...
    const handleSignOut = async (event) => {
        ...
        try {
            const response = await axios.get('https://umsbackendteo-production.up.railway.app/reg/signout')
    ...
    <>
        ...
        <>
          ...
          <button  class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={handleSignOut}>Sign out</button>
           ...
           <Link href="/studentreg/dashboard" class="text-white bg-gray-400 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">DashBoard</Link>
